"""Git handler abstraction for Project Red.
...
This PR was automatically generated by **Project Red** to fix a dbt pipeline error.
...
_Generated by [Project Red](https://github.com/your-org/project-red) — AI-powered dbt error resolution_
"""
        return description
...
class GHEHandler(GitHandler):
    ...
    def create_pr(
        ...
        raise NotImplementedError(
            "GitHub Enterprise integration is available in Project Red Enterprise. "
...
class GitLabHandler(GitHandler):
    ...
    def create_pr(
        ...
        """
        raise NotImplementedError(
            "GitLab integration is available in Project Red Enterprise. "
            "Contact us for enterprise licensing."
        )
